...
This paper release vendors the Mod-Cog task definitions and a minimal
NeuroGym compatibility subset needed by those task classes. It does not ship
the full NeuroGym task registry or generic `neurogym.Dataset` API. The pruning
experiments sample full Mod-Cog trials through `pruning_benchmark.tasks.ModCogTrialDM`.
