...
_TRIALENV_EXPECTS_FIVE = "terminated, truncated" in inspect.getsource(TrialEnv.step)


def _pack_step(ob, reward, info):
    if _TRIALENV_EXPECTS_FIVE:
...
class _Reach(EnvWithAdditions):
    ...
    def _step(self, action):
        ...
        return _pack_step(self.ob_now, reward, {'new_trial': new_trial, 'gt': gt})
...
class _DMFamily(EnvWithAdditions):
    ...
    def _step(self, action):
        ...
        return _pack_step(ob, reward, {'new_trial': new_trial, 'gt': gt})
